export const aboutMeContent: React.ReactNode[] = [
    ...
    <p className="paragraph-4 mb-4">
        At this time, I am currently seeking opportunities that best suit me and where I can continue to expand my knowledge in software development. My ultimate goal is to continue to grow in this career path and be able to utilize my skills to work alongside a team and make an impact in real-world projects. If you'd like to learn more about my background or see my work, I invite you to connect with me on {''}
        <a
            href='https://www.linkedin.com/in/gt24/'
            target="_blank"
            rel="noopener noreferrer"
            aria-label="linkedin"
            className="transition duration-300 underline md:no-underline md:hover:underline text-blue-600"
        >
            LinkedIn
        </a>
